...
const Wishlist = ({
  ...
  return (
    <Fragment>
      <MetaTags>
        <title>Super Copo | Favoritos</title>
        <meta
          name="description"
          content="Sua página de favoritos."
        />
      </MetaTags>
        ...
        <div className="cart-main-area pt-90 pb-100">
          <div className="container">
            {wishlistItems && wishlistItems.length >= 1 ? (
              <Fragment>
                <h3 className="cart-page-title">Seus itens da lista de desejos</h3>
                <div className="row">
                ...
                <div className="col-lg-12">
                  <div className="item-empty-area text-center">
                    ...
                    <div className="item-empty-area__text">
                      Nenhum item encontrado na lista de desejos <br />{" "}
